...
const Project = ({ title, description, tags, imageUrl, more, links }: TProject) => {
    ...
    return (
        ...
        >
            <section className="relative max-w-[45rem] overflow-hidden rounded-lg border border-black/5 bg-gray-100 transition hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:hover:bg-white/20 sm:h-[25rem] sm:pr-8 sm:group-even:pl-8">
