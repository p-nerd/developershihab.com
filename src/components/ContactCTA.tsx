...
const ContactCTA = () => {
    return (
        <aside class="flex flex-col items-center gap-12 border-y border-solid border-[#e3e6ee] bg-sx-gray-999_40 px-6 py-20 shadow-sx-shadow-sm lg:flex-row lg:flex-wrap lg:justify-between lg:p-[7.5rem] dark:border-[#283044]">
