...
const ContactCTA = () => {
    return (
        <aside class="bg-xx-gray-999-40 flex flex-col items-center gap-12 border-y border-solid border-[#e3e6ee] px-6 py-20 shadow-sm lg:flex-row lg:flex-wrap lg:justify-between lg:p-[7.5rem] dark:border-[#283044]">
