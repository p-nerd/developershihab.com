...
const CallToAction = (p: { href: string; children: JSXElement }) => {
    return (
        <a
            href={p.href}
            class="bg-sx-gr group relative flex items-center gap-2 overflow-hidden whitespace-nowrap rounded-full px-8 py-2 text-center leading-[1.1] text-xx-accent-text-over shadow-md lg:px-10 lg:py-[1.125rem] lg:text-[1.625rem]"
